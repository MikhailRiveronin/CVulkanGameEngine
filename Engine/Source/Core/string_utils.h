...
LIB_API char* string_copy(char* dest, char const* source);

LIB_API char* string_ncopy(char* dest, char const* source, i64 length);

LIB_API char* string_trim(char* str);

LIB_API void string_mid(char* dest, char const* source, i32 start, i32 length);
 ...
 */
LIB_API i32 string_index_of(char* str, char c);
